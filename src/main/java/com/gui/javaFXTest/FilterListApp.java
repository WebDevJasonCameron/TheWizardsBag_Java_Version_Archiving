...
public class FilterListApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ReadOnlyObjectProperty<ObservableList<Player>> playersProperty = new SimpleObjectProperty<>(FXCollections.observableArrayList());
        ...
        // Create a List View bound to the viewablePlayers property
